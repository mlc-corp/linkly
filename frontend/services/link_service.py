...
class LinkService:
    ...
    def _make_request(self, method: str, endpoint: str, **kwargs) -> requests.Response:
        ...
        try:
            response = requests.request(
                method=method, url=url, timeout=10, **kwargs  # 10 segundos de timeout
            )
            return response
    ...
    def get_link_by_id(self, link_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"[LinkService] Error al obtener link {link_id}: {response.status_code}"
                )
                return None
    ...
    def create_link(
        self, title: str, slug: str, destination_url: str, variants: List[str]
    ) -> Dict:
        """
    ...
    def delete_link(self, link_id: str) -> bool:
        ...
        try:
            ...
            if response.status_code == 204:
                ...
                print(
                    f"[LinkService] Error al eliminar link {link_id}: {response.status_code}"
                )
                return False
    ...
    def get_link_metrics(self, link_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"[LinkService] Error al obtener métricas de {link_id}: {response.status_code}"
                )
                return None
